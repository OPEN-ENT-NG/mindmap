...
return e.setStyles({border:"1px gray dashed",background:"rgba(98, 135, 167, .8)",color:"rgb(255, 255, 255)",outline:"0 none",resize:"none",overflow:"hidden",width:"auto",height:"auto",padding:"0px"}),e.inject(t),t},_registerEvents:function(t){var e=this._getTextareaElem()
...
e.each(function(t){i<t.length&&(i=t.length)}),t.setAttribute("cols",i),t.setAttribute("rows",e.length),this._containerElem.setStyles({width:i+1+"em",height:t.getSize().height})}},isVisible:function(){return $defined(this._containerElem)&&"block"==this._containerElem.getStyle("display")},_updateModel:function(){if(this._topic.getText()!=this._getText()){var t=this._getText(),e=this._topic.getId(),i=mindplot.ActionDispatcher.getInstance()
...
var i={fontSize:t.size+"px",fontFamily:t.font,fontStyle:t.style,fontWeight:t.weight,color:"rgb(255, 255, 255)"}
...
if(s.setStyle("margin","5px"),s.inject(o),$defined(t.getValue())){var r=new Element("input",{type:"button",value:$msg("REMOVE"),"class":"btn-primary"})
...
var i=new Element("form",{action:"none",id:"linkFormId"}),n=new Element("label",{text:"URL"})
n.setStyles({margin:"5px"}),n.inject(i)
var o=new Element("input",{placeholder:"http://www.example.com/",type:(Browser.ie,"text"),required:!0,autofocus:"autofocus"})
...
s.setStyle("float","right"),s.inject(i),s.addEvent("click",function(){window.open(o.value,"_blank","status=1,width=700,height=450,resizable=1")}),i.addEvent("submit",function(e){e.stopPropagation(),e.preventDefault(),null!=o.value&&""!=o.value.trim()&&t.setValue(o.value),this.close()}.bind(this))
var r=new Element("div").setStyles({paddingTop:35,textAlign:"center"}),a=new Element("input",{type:"submit",value:$msg("ACCEPT"),"class":"btn-primary"})
if(a.setStyle("margin","5px"),a.inject(r),$defined(t.getValue())){var l=new Element("input",{type:"button",value:$msg("REMOVE"),"class":"btn-primary"})
