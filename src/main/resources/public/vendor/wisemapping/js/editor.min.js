...
$assert(container,"container could not be null"),designer=new mindplot.Designer(options,container),window.onerror=function(e,t,n){if("Script error."!==e||0!=n){var i=e
...
designer._cleanScreen=function(){menu.clear()}}return designer}function loadDesignerOptions(e){var t
if(e){var n=new Request.JSON({url:e,async:!1,onSuccess:function(e){this.options=e}.bind(this)})
n.get(),t=this.options}else{var i=$moo("mindmap-content").getPosition(),o={height:parseInt(window.innerHeight)-i.y-30,width:$moo("toolbar").getSize().x},r={height:parseInt(window.innerHeight)-i.y-70-30,width:$moo("toolbar").getSize().x}
$moo("toolbar").setStyle("width",r.width),$moo("header").setStyle("width",r.width),t={readOnly:!1,zoom:.85,saveOnLoad:!0,size:o,viewPort:r,container:"mindplot",locale:"en"}}return t}var designer=null
...
var t=new Element("img",{src:"/mindmap/public/vendor/wisemapping/images/ajax-loader.gif"})
return t.setStyle("margin-top","15px"),t.inject(e),e},show:function(){this.open()},destroy:function(){this.parent(),this.overlay.destroy()}})
