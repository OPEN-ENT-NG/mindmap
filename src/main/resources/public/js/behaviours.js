...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * Register behaviours.
	 */
	entcore_1.Behaviours.register('mind-map', {
	    ...
	    workflow: function () {
	        ...
	        for (var prop in mindmapWorkflow) {
	            if (entcore_1.model.me.hasWorkflow(mindmapWorkflow[prop])) {
	                workflow[prop] = true;
	            }
	        }
	        return workflow;
	    ...
	    loadResources: function (callback) {
	        axios_1.default.get('/mindmap/list/all').then(function (mindmaps) {
	            this.resources = entcore_1._.map(mindmaps, function (mindmap) {
